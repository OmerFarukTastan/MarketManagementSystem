    ...
    public partial class ProductForm : Form
    {
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string updateQuery = "UPDATE Product SET ProdName='" + TextBox_name.Text + "',ProdPrice=" + TextBox_price.Text + ",ProdQyt=" + TextBox_qty.Text + " ,ProdCat = '" + comboBox_category.Text + "'WHERE ProdId =" + TextBox_id.Text + "";
